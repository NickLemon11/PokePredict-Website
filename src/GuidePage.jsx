...
export default function Guide() {
    return (
    <>
    <div className="main-content" id="guide">1. Enter the details of each Pokémon into team viewer including your opponent's Pokémon and move's of which you know. All Pokémon data is sourced officially from PokeAPI. Should you experience trouble with entering a specific name, ensure it is the official spelling of said Pokémon.<br/> 
                                            ...
                                            <img className="guideImage" src={guideImage2}></img>   <br />
                                             3. Click the green button to ready up the Pokémon. Then using the upper menu, switch view and enter the number of turns you want us to predict. PokéPredict will simulate those look ahead turns and determine your optimal plays to help you win. Also input the active Pokémon and their status condition. <br/>
